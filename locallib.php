 ...
 */
function block_tb_testimonials_updateconf() {
    if (isset(get_config('block_tb_testimonials')->license)) {
    ...
    if ($infoleeloolxp->status != 'false') {
        ...
        set_config('settingsjson', base64_encode($output), 'block_tb_testimonials');
        return;
    }
